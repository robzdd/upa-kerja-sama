            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    <a href="{{ route('mitra.lowongan.edit', $lowongan->id) }}" 
                       class="px-4 py-2 bg-yellow-50 text-yellow-600 rounded-lg hover:bg-yellow-100 transition-colors font-medium flex items-center gap-2">
                        <i class="fas fa-edit"></i> Edit
                    </a>
                    <form action="{{ route('mitra.lowongan.destroy', $lowongan->id) }}" method="POST" class="delete-form">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="px-4 py-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-colors font-medium flex items-center gap-2">
