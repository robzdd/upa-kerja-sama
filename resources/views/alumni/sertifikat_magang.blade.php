...
<div class="max-w-7xl mx-auto mt-8 mb-12 px-4">
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <nav class="space-y-2">
                    ...
                    <a href="{{ route('alumni.certificates') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg bg-blue-50 border-l-4 border-blue-600 text-blue-700 transition-colors">
                        <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>
                        </svg>
                        <span class="text-sm font-semibold">Sertifikat Magang</span>
                    </a>
    ...
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Sertifikat Magang</h1>
        <p class="text-gray-600">Dokumen sertifikat magang yang diberikan oleh mitra perusahaan</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-500">Sertifikat Valid</p>
                    <p class="text-2xl font-semibold text-gray-900">3</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-500">Perusahaan Mitra</p>
                    <p class="text-2xl font-semibold text-gray-900">3</p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex justify-between items-center">
                <h3 class="text-lg font-semibold text-gray-900">Daftar Sertifikat Magang</h3>
        ...
        <div class="p-6">
                ...
                <div class="border border-gray-200 rounded-lg p-6">
                    <div class="flex items-start justify-between">
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="flex-1">
                                <h4 class="text-lg font-semibold text-gray-900">Sertifikat Magang Software Development</h4>
                                <p class="text-sm text-gray-600 mb-2">PT Tech Solutions Indonesia</p>
                                ...
                                <p class="text-sm text-gray-600 mt-2">Magang sebagai Software Developer dengan fokus pada pengembangan aplikasi web menggunakan Laravel dan Vue.js.</p>
                            </div>
                        </div>
                ...
                <div class="border border-gray-200 rounded-lg p-6">
                    <div class="flex items-start justify-between">
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="flex-1">
                                <h4 class="text-lg font-semibold text-gray-900">Sertifikat Magang Digital Marketing</h4>
                                <p class="text-sm text-gray-600 mb-2">CV Digital Agency</p>
                                <div class="flex items-center space-x-4 text-sm text-gray-500">
                                    <span class="flex items-center">
                                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                ...
                                <p class="text-sm text-gray-600 mt-2">Magang sebagai Digital Marketing Specialist dengan fokus pada social media marketing dan content creation.</p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-2">
                            <button class="px-3 py-1 bg-blue-100 text-blue-700 rounded text-sm hover:bg-blue-200">
                ...
                <div class="border border-gray-200 rounded-lg p-6">
                    <div class="flex items-start justify-between">
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="flex-1">
                                <h4 class="text-lg font-semibold text-gray-900">Sertifikat Magang Data Analysis</h4>
                                <p class="text-sm text-gray-600 mb-2">PT Data Solutions</p>
                                <div class="flex items-center space-x-4 text-sm text-gray-500">
                                    <span class="flex items-center">
                                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                ...
                                <p class="text-sm text-gray-600 mt-2">Magang sebagai Data Analyst dengan fokus pada analisis data menggunakan Python, SQL, dan Tableau.</p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-2">
                            <button class="px-3 py-1 bg-blue-100 text-blue-700 rounded text-sm hover:bg-blue-200">
            ...
            <div class="text-center py-12">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2">Belum ada sertifikat magang</h3>
                <p class="text-gray-500 mb-4">Sertifikat magang akan muncul setelah Anda menyelesaikan program magang</p>
            </div>
        </div>
    </div>
</div>
