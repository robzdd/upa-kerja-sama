        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <div class="text-center mb-6">
                @if($user->alumni && $user->alumni->profile_photo)
                    <img src="{{ asset('storage/' . $user->alumni->profile_photo) }}" alt="Profile Photo" class="w-24 h-24 mx-auto mb-4 rounded-full object-cover ring-4 ring-blue-50">
                @elseif($user->foto)
                    <img src="{{ asset('storage/' . $user->foto) }}" alt="Profile Photo" class="w-24 h-24 mx-auto mb-4 rounded-full object-cover ring-4 ring-blue-50">
                @else
