...
<head>
    ...
    <title>Reset Password - Alumni</title>
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form method="POST" action="{{ route('alumni.password.update') }}">
                ...
                <button type="submit" class="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold py-3 rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl">
                    Reset Password
                </button>
            </form>
        </div>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600">
                <a href="{{ route('alumni.login') }}" class="text-blue-600 hover:text-blue-700 font-semibold">Kembali ke Login</a>
            </p>
        </div>
    </div>
</body>
