...
<body class="bg-gradient-to-br from-purple-50 to-indigo-100 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <!-- Back to Login Link -->
        <div class="mb-4">
            <a href="{{ route('mitra.login') }}" class="inline-flex items-center text-sm text-gray-600 hover:text-purple-600 transition">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <!-- Form -->
            <form id="forgot-password-form" method="POST" action="{{ route('mitra.password.email') }}">
                @csrf
                ...
                <button type="submit" id="submit-btn" class="w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold py-3 rounded-lg hover:from-purple-700 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed">
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    Ingat password Anda?
                    <a href="{{ route('mitra.login') }}" class="text-purple-600 hover:text-purple-700 font-semibold">Login</a>
                </p>
            </div>
        </div>
