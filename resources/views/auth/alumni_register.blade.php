...
<head>
    ...
    <title>Registrasi Portal Kerja POLINDRA</title>
...
<body class="min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col justify-between p-12 text-white w-full">
            ...
            <div>
                <h2 class="text-3xl font-bold mb-2">Gabung sekarang</h2>
                <h2 class="text-3xl font-bold">dan raih peluang kerja!</h2>
            </div>
        </div>
    </div>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-500 text-sm">Buat akun dan mulai akses Portal Kerja POLINDRA</p>
                </div>
