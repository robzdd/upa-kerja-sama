        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Tambah Artikel</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl shadow-xl p-8 mb-6 text-white">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                <p class="text-blue-100 mt-1">Buat artikel profesional dengan fitur lengkap</p>
            </div>
        </div>
    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="excerpt" 
                                      ...
                                      placeholder="Tulis ringkasan singkat artikel untuk ditampilkan di halaman daftar">{{ old('excerpt') }}</textarea>
                            @error('excerpt')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                    ...
                    <div>
                        <textarea id="konten" 
                                  name="konten" 
                                  rows="20"
                                  class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition @error('konten') border-red-500 @enderror">{{ old('konten') }}</textarea>
                        @error('konten')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
