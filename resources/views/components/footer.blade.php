    ...
    <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div>
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-xl font-bold">UPA KERJASAMA</span>
                </div>
                <p class="text-gray-400 leading-relaxed mb-6">
                    Menjembatani alumni Politeknik Negeri Indramayu dengan dunia industri. Temukan karir impianmu bersama kami.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3 text-gray-400">
                        ...
                        <span>Jl. Raya Lohbener Lama No.08, Lohbener, Indramayu, Jawa Barat 45252</span>
                    </li>
                    <li class="flex items-center gap-3 text-gray-400">
                        <svg class="w-6 h-6 text-blue-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                        <span>upakerjasama@polindra.ac.id</span>
                    </li>
                    <li class="flex items-center gap-3 text-gray-400">
                        <svg class="w-6 h-6 text-blue-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-500 text-sm mb-4 md:mb-0">
                &copy; {{ date('Y') }} UPA Kerjasama Politeknik Negeri Indramayu. All rights reserved.
            </p>
