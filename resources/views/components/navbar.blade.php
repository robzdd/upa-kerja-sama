            ...
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="{{ Auth::check() ? route('alumni.beranda') : route('home') }}"
                        class="hover:text-gray-200 transition {{ request()->routeIs('home') || request()->routeIs('alumni.beranda') ? 'font-semibold border-b-2 border-white pb-1' : '' }}">Beranda</a>
                    ...
                    <a href="{{ route('alumni.cari_lowongan') }}" class="hover:text-gray-200 transition {{ request()->routeIs('alumni.cari_lowongan') ? 'font-semibold border-b-2 border-white pb-1' : '' }}">Cari Lowongan</a>
                    <a href="{{ route('alumni.list_perusahaan') }}" class="hover:text-gray-200 transition {{ request()->routeIs('alumni.list_perusahaan') ? 'font-semibold border-b-2 border-white pb-1' : '' }}">List Perusahaan</a>
